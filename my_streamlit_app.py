...
df_final = pd.read_csv('https://raw.githubusercontent.com/JBLFT/creuse_ta_base/main/df_final_ML.csv')
df_final.drop(columns = 'Unnamed: 0', inplace = True )

url = pd.read_csv('https://raw.githubusercontent.com/JBLFT/creuse_ta_base/main/df_hugo_max-2.csv') # Final TMBD
acteur_realisateur = pd.read_csv('https://raw.githubusercontent.com/JBLFT/creuse_ta_base/main/acteur_realisateur.csv') # Personnes
